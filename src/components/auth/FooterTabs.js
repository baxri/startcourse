    ...
    return (
        <Footer style={styles.footer}>
            <FooterTab style={styles.footerTab}>
                <Ripple vertical rippleOpacity={0.1} ippleContainerBorderRadius={0} style={active == 'home' ? styles.buttonActive : styles.button}
                ...
                <Ripple rippleOpacity={0.1} rippleContainerBorderRadius={0} vertical style={active == 'trip' ? styles.buttonActive : styles.button}
                ...
                <Ripple rrippleOpacity={0.1} ippleContainerBorderRadius={0} vertical style={active == 'bids' ? styles.buttonActive : styles.button}
                ...
                <Ripple rippleOpacity={0.1} rippleContainerBorderRadius={0} vertical style={active == 'setup' ? styles.buttonActive : styles.button}
